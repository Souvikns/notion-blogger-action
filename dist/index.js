...
const notion_blogger_1 = __importDefault(__nccwpck_require__(3410));
...
async function run() {
    const notionBlogger = new notion_blogger_1.default({
        notion: {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.NotionBlogger = void 0;
const notion_1 = __nccwpck_require__(4489);
const blogger_1 = __nccwpck_require__(234);
const service_1 = __importDefault(__nccwpck_require__(914));
class NotionBlogger {
    notion;
    blogger;
    constructor(config) {
        this.notion = notion_1.NotionAdapter.instantiate(config.notion);
        if (!config.services) {
            this.blogger = new blogger_1.Blogger(service_1.default);
        }
        else {
            this.blogger = new blogger_1.Blogger({
                ...service_1.default,
                ...config.services
            });
        }
...
exports.NotionBlogger = NotionBlogger;
...
class Blogger {
    blogServices;
    constructor(blogServices) {
        this.blogServices = blogServices;
    }
    async post(blog, config) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(7891), exports);
const app_1 = __nccwpck_require__(6067);
exports["default"] = app_1.NotionBlogger;
//# sourceMappingURL=index.js.map
...
const notion_to_md_1 = __importDefault(__nccwpck_require__(9143));
class NotionAdapter {
    notion;
    database_id;
    n2m;
    ...
    async fethReadyBlogs(targetLabel) {
        if (!targetLabel) {
...
exports["default"] = {
    dev: async (blog, config) => {
        ...
        const { status } = await axios_1.default.post('https://dev.to/api/articles', {
            "article": {
                title: blog.title,
                published: false,
...
const md = __nccwpck_require__(3251);
const { getBlockChildren } = __nccwpck_require__(9069);
class notion2md {
  constructor(options) {
    if (!options) {
